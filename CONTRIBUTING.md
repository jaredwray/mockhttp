...
2) Run tests and linting locally.
	...
	- Run `pnpm install`.
	- Run `pnpm test`.
	- If you change documentation, run `pnpm website:build` to regenerate the OpenAPI spec and Docula site. Docula requires Node `^22.19.0 || >=24` (CI uses Node 24). The published MockHTTP runtime still supports Node `>=22.18.0`.
