...
const replaceValue = '[![https://mockhttp.org/logo.svg](https://mockhttp.org/logo.svg)](https://mockhttp.org)';

// Run the function
copyAndReplaceText(originalFile, newFile, searchValue, replaceValue);
